...
INSERT INTO `energia` (`id`, `nombre`, `significado`, `htmlCodigo`, `nombreYucateco`, `categoria`,`ruta`) VALUES
...
,'Calendario_Cholquij\\Energias\\jun.png'),
...
,'Calendario_Cholquij\\Energias\\keb.png'),
...
,'Calendario_Cholquij\\Energias\\oxib.png'),
...
,'Calendario_Cholquij\\Energias\\kajib.png'),
...
,'Calendario_Cholquij\\Energias\\job.png'),
...
,'Calendario_Cholquij\\Energias\\waqib.png'),
...
,'Calendario_Cholquij\\Energias\\wuqub.png'),
...
,'Calendario_Cholquij\\Energias\\wajxaqib.png'),
...
,'Calendario_Cholquij\\Energias\\belejeb.png'),
...
,'Calendario_Cholquij\\Energias\\lajuj.png'),
...
,'Calendario_Cholquij\\Energias\\julajuj.png'),
...
,'Calendario_Cholquij\\Energias\\kablajuj.png'),
...
,'Calendario_Cholquij\\Energias\\oxlajuj.png');
...
INSERT INTO `kin` (`id`, `iddesk`, `nombre`, `significado`, `htmlCodigo`, `categoria`, `nombreYucateco`,`ruta`) VALUES
...
,'Calendario_Haab\\Kines\\Imix.png'),
...
,'Calendario_Haab\\Kines\\Akbal.jpg'),
...
,'Calendario_Haab\\Kines\\Chikchan.png'),
...
,'Calendario_Haab\\Kines\\Kimi.png'),
...
,'Calendario_Haab\\Kines\\Manik.png'),
...
,'Calendario_Haab\\Kines\\Lamat.png'),
...
,'Calendario_Haab\\Kines\\Muluk.png'),
...
,'Calendario_Haab\\Kines\\Chuwen.png'),
...
,'Calendario_Haab\\Kines\\Kaban.png'),
...
,'Calendario_Haab\\Kines\\Etznab.png'),
...
,'Calendario_Haab\\Kines\\Kawak.png'),
...
,'Calendario_Haab\\Kines\\Ajaw.png');
...
INSERT INTO `nahual` (`idweb`, `iddesk`, `nombre`, `nombreYucateco`, `significado`, `htmlCodigo`, `categoria`, `descripcion`, `ruta`) VALUES
...
,'Calendario_Cholquij\\Nahuales\\cholquij-tzikin.png'),
...
,'Calendario_Cholquij\\Nahuales\\cholquij-ajmaq.png'),
...
,'Calendario_Cholquij\\Nahuales\\cholquij-noj.png'),
...
,'Calendario_Cholquij\\Nahuales\\cholquij-tijax.png'),
...
,'Calendario_Cholquij\\Nahuales\\cholquij-kawoq.png'),
...
,'Calendario_Cholquij\\Nahuales\\cholquij-ajpu.png'),
...
,'Calendario_Cholquij\\Nahuales\\cholquij-imox.png'),
...
,'Calendario_Cholquij\\Nahuales\\cholquij-iq.png'),
...
,'Calendario_Cholquij\\Nahuales\\cholquij-aqabal.png'),
...
,'Calendario_Cholquij\\Nahuales\\cholquij-kat.png'),
...
,'Calendario_Cholquij\\Nahuales\\cholquij-kan.png'),
...
,'Calendario_Cholquij\\Nahuales\\cholquij-kame.png'),
...
,'Calendario_Cholquij\\Nahuales\\cholquij-kej.png'),
...
,'Calendario_Cholquij\\Nahuales\\cholquij-qanil.png'),
...
,'Calendario_Cholquij\\Nahuales\\cholquij-batz.png'),
...
,'Calendario_Cholquij\\Nahuales\\cholquij-e.png'),
...
,'Calendario_Cholquij\\Nahuales\\cholquij-aj.png'),
...
,'Calendario_Cholquij\\Nahuales\\cholquij-ix.png');
...
(1, 'Animacion', 'Rueda Calendarica', 'Informacion', '<img class="rueda" src="..\\imgs\\cuentaLarga.png" >'),
...
(0, 'Wayeb\'', 'Dias desafortunados, reflexion, gracia y penitencia', 5, '<p>Cuando llegaban los cinco días sin nombre conocidos como <strong>uayeb</strong>, los mayas no se bañaban, no hacían obras serviles o de trabajo, porque temían que al realizar alguna actividad, les iría mal.</p>', 'Uinal_0', 18, 'Calendario_Haab\\Uinal\\haab-wayeb.png'),
(1, 'Pop', 'Mat (símbolo de comunidad y matrimonio), petate', 20, '<p>Este mes era una especie de año nuevo, era una fiesta muy celebrada, renovaban todas las cosas de utensilios de casa, como platos, vasos, banquillos, ropa, mantillas, barrían su casa y la asura la echaban fuera del pueblo, pero antes de la fiesta al menos <strong>13 </strong>días ayunaban y se abstenían de tener sexo, no comían sal, ni chile, algunas personas ampliaban este período de abstinencia  hasta tres uinales. Después todos los hombres se reunían con el sacerdote en el patio del templo y ponían una porción de copal en el brasero para quemarlo.</p>', 'Uinal_1', 0, 'Calendario_Haab\\Uinal\\haab-pop.png'),
(2, 'Woo', 'Rana, sapo, negro', 20, '<p>En este mes se realizaban festividades para sacerdotes, adivinadores, la ceremonia era llamada pocam, y oraban quemando copal a Kinich Ahau Itzamná, a quien consideraban el primer sacerdote. Con <em><strong>«agua virgen traída del monte, donde no llegase mujer»</strong></em> untaban las tablas de los libros y el sacerdote realizaba los pronósticos del año, realizaban un baile llamado okotuil.</p>', 'Uinal_2', 1, 'Calendario_Haab\\Uinal\\haab-woo.png'),
(3, 'Zip', 'Rojo, conjuncion', 20, '<p>En este mes se juntaban los sacerdotes con sus mujeres, y usaban idolillos de la diosa <strong>Ixchel</strong>, y la fiesta se llamaba<strong> Ibcil Ixchel</strong>, invocaban a los dioses de la medicina que eran <strong>Itzamná</strong>, <strong>Citbolontun </strong>y <strong>Ahau Chamahez</strong>, realizaban un baile llamado Chantunyab. El día siete del uinal zip día invocaban a los dioses de la caza <strong>Ah Cancum, Zuhuyzib Zipitabai</strong>, y otros, cada cazador sacaba una flecha y una cabeza de venado las cuales eran untadas de betún azul, y bailaban con las flechas en las manos, se horadaban las orejas, otros la lengua y pasaban por los agujeros siete hojas de una hierba llamada <strong>Ac</strong>. Al día siguiente era el turno de los pescadores, pero ellos untaban de betún azul sus aparejos de pesca y no se horadaban las orejas, sino que se ponían arpones, y bailaban el <strong>Chohom</strong>, y después de realizada la ceremonia iban a la costa a pescar, los dioses eran <strong>Abkaknexoi, Abpua, y Ahcitzamalcun</strong>.</p>', 'Uinal_3', 2, 'Calendario_Haab\\Uinal\\haab-zip.png'),
(4, 'Sotz\'', 'Bat (murcielago)', 20, '<p>En este mes los apicultores comenzaban los preparativos pero celebraban su fiesta en el uinal siguiente <strong>tsek</strong>, los sacerdotes y oficiales ayunaban, así como algunos voluntarios.</p>', 'Uinal_4', 3, 'Calendario_Haab\\Uinal\\haab-sotz.png'),
(5, 'Tzek', 'Fin, palma, calavera', 20, '<p>En este mes no derramaban <strong>sangre</strong>, los dioses venerados eran los cuatro <strong>bacabs</strong>, especialmente <strong>Hobnil</strong>. Ofrecían a los <strong>bacabs </strong>platos con figuras de miel, y los mayas bebían un vino llamado balche, el cual se procesaba de la corteza del árbol de ese nombre<em> (Lonchucarpus violaceus)</em>, los apicultores regalaban miel en abundancia.</p>', 'Uinal_5', 4, 'Calendario_Haab\\Uinal\\haab-tzek.png'),
(6, 'Xul', 'Perro, instrumento musical', 20, '<p>Este mes era dedicado a <strong>Kukulcán</strong>, los mayas iban por el jefe supremo de los guerreros llamado <strong>Nacom</strong>, al cual sentaban en el templo quemando copal, realizaban un baile de guerreros llamado <strong>Holkanakot</strong>, sacrificando un perro y quebrando ollas llenas de bebida para terminar su fiesta, y regresar con honores al <strong>Nacom </strong>a su casa. Esta ceremonia se celebraba en todos lados hasta la destrucción de <strong>Mayapán</strong>, después solo se celebraba en Maní en la jurisdicción de los <strong>Tutul xiúes</strong>, todos los señores se juntaban presentaban cinco banderas de pluma, y se iban al templo de <strong>Kukulcán</strong>, donde oraban durante cinco días, después de los cuales bajaba <strong>Kukulcán </strong>del cielo y recibía las ofrendas, la fiesta se llamaba <strong>Chikabán</strong>.</p>', 'Uinal_6', 5, 'Calendario_Haab\\Uinal\\haab-xul.png'),
(7, 'Yaxk\'in', 'Primer Sol (o verde), inicio agricola, nuevo dia', 20, '<p>En este mes se realizaba la ceremonia se llamaba <strong>Olob-Zab-Kamyax</strong>, se untaban todos los instrumentos de todos los oficios con betún azul, se juntaban los niños y las niñas del pueblo y les daban unos golpecillos en los nudillos, con la idea que los niños fueran expertos en los oficios de sus padres. Desde este uinal comenzaban a aparejarse para la ceremonia del uinal <strong>Mol</strong>.</p>', 'Uinal_7', 6, 'Calendario_Haab\\Uinal\\haab-yaxkin.png'),
(8, 'Mol', 'Inicio de lluvia, agua, jade', 20, '<p>En este mes los apicultores oraban a los dioses para que hubiese buenas flores y de esta manera tener una buena producción de las abejas,.en este mes era cuando fabricaban las <strong>efigies </strong>o ídolos de madera, los cuales eran de alguna forma bendecidos por los sacerdotes. Se practicaba un ritual en el cual se<em> sangraban las orejas.</em></p>', 'Uinal_8', 7, 'Calendario_Haab\\Uinal\\haab-mol.png'),
(9, 'Ch\'en', 'Lluvia, negro, acido', 20, '<p>En este mes hacían una fiesta llamaba <strong>ocná</strong>, que quiere decir <em>«renovación del templo»</em>, la hacían en honor de los dioses de los maizales; los mayas acostumbraban tener ídolos de los dioses con pequeños braseros en donde quemaban copal, en esta fiesta cada año se renovaban los ídolos de barro y sus braseros.</p>', 'Uinal_9', 8, 'Calendario_Haab\\Uinal\\haab-chen.png'),
(10, 'Yax', 'Verde, humedad', 20, '<p>En este mes hacían una fiesta llamaba <strong>ocná</strong>, que quiere decir <em>«renovación del templo»</em>, la hacían en honor de los dioses de los maizales; los mayas acostumbraban tener ídolos de los dioses con pequeños braseros en donde quemaban copal, en esta fiesta cada año se renovaban los ídolos de barro y sus braseros.</p>', 'Uinal_10', 9, 'Calendario_Haab\\Uinal\\haab-yax.png'),
(11, 'Sak', 'Blanco, lluvia', 20, '<p>En este mes el sacerdote y los cazadores hacían una ceremonia para aplacar a los dioses de la ira, y como una forma de penitencia por la sangre derramada durante la cazas (los mayas tenían como <em>«cosa horrenda»</em> cualquier derramamiento de sangre si dicho derramamiento no era en sus sacrificios), por eso cuando iban a la caza invocaban al dios de la caza, le quemaban copal y si podían le untaban al rostro del ídolo de la caza, la sangre del corazón de la presa.</p>', 'Uinal_11', 10, 'Calendario_Haab\\Uinal\\haab-sak.png'),
(12, 'Keh', 'Rojo, venado', 20, '<p>En las proximidades de este mes existía una fiesta muy grande y de fecha movible que duraba tres días, con quema de copal, a la cual Landa llamaba <strong><em>«sahumerías»</em></strong>, ofrendas y borrachera. Los sacerdotes tenían cuidado de avisar con tiempo para realizar un ayuno previo</p>', 'Uinal_12', 11, 'Calendario_Haab\\Uinal\\haab-keh.png'),
(13, 'Mak', 'Red, cautiverio, pecado', 20, '<p>En este mes la gente anciana realizaba una ceremonia llamada <strong>«tupp kak»</strong> <em>(matar el fuego)</em>, era dirigida a los dioses de los panes y a Itzamná, en una fogata quemaban corazones de aves y animales, una vez incinerados los corazones apagaban el fuego con cántaros de agua. Se juntaba el pueblo y los sacerdotes y untaban con lodo y betún azul los primeros escalones de las escaleras de sus templos. En esta fiesta no realizaban ayuno, a excepción del sacerdote</p>\n', 'Uinal_13', 12, 'Calendario_Haab\\Uinal\\haab-mak.png'),
(14, 'K\'ank\'in', 'Sol amarillo', 20, '<p>Hasta la fecha se desconocen los <em>dioses </em>que se honraban en este periodo del año maya</p>', 'Uinal_14', 13, 'Calendario_Haab\\Uinal\\haab-sak.png'),
(15, 'Muwan', 'Halcon, buho', 20, '<p>Este mes correspondía a los cultivadores de cacao realizar una ceremonia a los dioses <strong>Chac Ek chuah, </strong>y<strong> Hobnil</strong>, sacrificaban un perro manchado con el color de cacao, y quemaban incienso y ofrecían iguanas de las azules<em> (probablemente untadas de betún azul)</em> y ciertas plumas de pájaros, terminada la ceremonia los mayas se comían las ofrendas.</p>', 'Uinal_15', 14, 'Calendario_Haab\\Uinal\\haab-keh.png'),
(16, 'Pax', 'Tiempo de siembra, tambor, musica', 20, '<p>En este mes la ceremonia se llamaba<strong> pacum chac</strong>, y por un período de cinco noches se juntaban los señores <em>(batab)</em> y los sacerdotes (ah kin) de los pueblos menores <em>(batabil)</em>, en las capitales y veneraban a <strong>Cit chac cob</strong>. Se homenajeaba con copal al jefe de los guerreros <em>(nacom)</em> durante cinco días, realizaban un baile de los guerreros llamado <strong>HOLKANAKOT</strong>. El sentido de esta ceremonia era para pedir a sus dioses alcanzar la victoria frente a sus enemigos. Se sacrificaba un perro, al cual se le extraía el corazón, se rompían ollas grandes que contenían bebida, y daban por finalizada la ceremonia, regresando a sus pueblos.</p>', 'Uinal_16', 15, 'Calendario_Haab\\Uinal\\haab-pax.png'),
(17, 'K\'ayab\'', 'Tortuga, guacamaya', 20, '<p>Durante los meses <strong>kayab </strong>y <strong>Kumku </strong>en cada población hacían fiestas a las cuales llamaban <strong>zabacilthan</strong>, se reunían para presentar ofrendas, comer y beber preparándose para el <strong><em>uayeb</em></strong>, el mes corto de los cinco días nefastos. </p>', 'Uinal_17', 16, 'Calendario_Haab\\Uinal\\haab-kayab.png'),
(18, 'K\'umk\'u\'', 'Maiz maduro, granero, oscuridad', 20, '<p>Durante los meses <strong>kayab </strong>y <strong>Kumku </strong>en cada población hacían fiestas a las cuales llamaban <strong>zabacilthan</strong>, se reunían para presentar ofrendas, comer y beber preparándose para el <strong><em>uayeb</em></strong>, el mes corto de los cinco días nefastos. </p>', 'Uinal_18', 17, 'Calendario_Haab\\Uinal\\haab-kumku.png');


--aqui lo que se tenia antes 
...
(2, 'administrador', 'Usuario con privilegios de administrar la informacion de la pagina');



INSERT INTO `usuario` (`usuario`, `password`, `nombre`, `apellido`, `correo`, `fechaNacimiento`, `telefono`, `imagen`, `id_rol`) VALUES
