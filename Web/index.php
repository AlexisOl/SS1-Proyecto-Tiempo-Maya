...
$horarioDeterminado = '';
    ...
    if ($pruebaDatetime >= $amanecerDatetime1 && $pruebaDatetime <= $amanecerDatetime2) {
      $horarioDeterminado = 'amanecer';
    } else if ($pruebaDatetime >= $medioDiaDatetime1 && $pruebaDatetime <= $medioDiaDatetime2) {
            $horarioDeterminado = 'mediodia';

    } else if ($pruebaDatetime >= $tardeDatetime1 && $pruebaDatetime <= $tardeDatetime2) {
            $horarioDeterminado = 'tarde';

    } else if ($pruebaDatetime >= $nocheDatetime1 && $pruebaDatetime <= $nocheDatetime2) {
           $horarioDeterminado = 'noche';

    } else if ($pruebaDatetime <= $nocheDatetime2Alt) {
         $horarioDeterminado = 'noche';
